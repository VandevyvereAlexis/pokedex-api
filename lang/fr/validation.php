...
return [
    ...
    | plusieurs versions, comme les règles de taille. N'hésitez pas
    | à ajuster ces messages.
    |
    */
    ...
    'ascii'           => 'Le champ :attribute ne doit contenir que des caractères alphanumériques en un seul octet et des symboles.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Le champ :attribute est compromis dans une violation de données. Veuillez choisir un autre :attribute.',
    ],
    ...
    | pour des attributs en utilisant la convention
    | "attribute.rule" pour nommer les lignes. Cela permet de
    | spécifier un message personnalisé pour une règle donnée.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes sont utilisées pour échanger notre
    | espace réservé d'attribut avec quelque chose de plus lisible,
    | comme "Adresse e-mail" au lieu de "email". Cela nous aide
    | à rendre les messages plus clairs.
    |
    */
